...
/*   Updated: 2018/08/09 19:03:37 by mhoosen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	process_wall_token(t_cell *cell, char c)
{
	...
	tmp_name[1] = c;
	tmp_name[2] = 'n';
	if (!(cell->wall.tex_n = texture_sys(TEXAS_GET, tmp_name)))
		return ;
	tmp_name[2] = 's';
	if (!(cell->wall.tex_s = texture_sys(TEXAS_GET, tmp_name)))
		return ;
	tmp_name[2] = 'w';
	if (!(cell->wall.tex_w = texture_sys(TEXAS_GET, tmp_name)))
		return ;
	tmp_name[2] = 'e';
	if (!(cell->wall.tex_e = texture_sys(TEXAS_GET, tmp_name)))
		return ;
	cell->type = WALL;
}
...
void	process_door_token(t_cell *cell, char c)
{
	...
	tmp_name[1] = c;
	if (!(cell->door.tex = texture_sys(TEXAS_GET, tmp_name)))
		return ;
...
void	process_key_token(t_cell *cell, char c)
{
	...
	tmp_name[1] = c;
	if (!(cell->key.tex = texture_sys(TEXAS_GET, tmp_name)))
		return ;
...
void	process_prop_token(t_cell *cell, char c)
{
	...
	tmp_name[1] = c;
	if (!(cell->prop.tex = texture_sys(TEXAS_GET, tmp_name)))
		return ;
	cell->type = PROP;
}
